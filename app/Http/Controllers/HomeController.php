...
class HomeController extends Controller
{
    ...
    public function about()
    {
        ...
        $Posts = Post::orderBy('created_at','desc')->paginate(2);
        //To Get All Gallery active OUT SIDE IN HOME VIEW
        $Gallers = Gallery::orderBy('created_at','desc')->paginate(9);
    ...
    {
         if (Session::get('lang') == 'German'){
           return view('German.bank');   
         }
         else{
           return view('english.bank'); 
         }
    }
    ...
    {
        //To Get All Gallery active OUT SIDE IN HOME VIEW
        $Gallery = Gallery::orderBy('created_at','desc')->paginate(200);

        if (Session::get('lang') == 'German'){
           return view('German.Gallery.index',compact('Gallery'));   
        }
        // To Get Change The Language Arabic or English or German
        else{
           return view('english.Gallery.index',compact('Gallery')); 
        }
