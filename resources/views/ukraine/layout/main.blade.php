    ...
    <header class="default-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                ...
                @guest
                <!-- =============================== BASE ======================================== -->
                <a href="{{ route('login') }}" class="genric-btn primary small"><i class=" icon-material-outline-face"></i> {{ __('Anmeldung') }}</a>
                @else
                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                document.getElementById('logout-form').submit();" class="genric-btn primary small"><i class="icon-feather-log-in"></i> {{ __('Ausloggen') }}</a>
    ...
    <div class="footer-area">
        <div class="container">
            <div class="row section_gap">
              ...
              <div class="col-md-3">
                <div class="single-footer-widget tp_widgets">
                    <h4 class="footer_title">Sprachen</h4>
            ...
            <div class="offset-lg-1 col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h4 class="footer_title">Kontaktiere uns</h4>
                    <div class="ml-5">
                        <p class="sm-head">
