        ...
        <div class="card-body p-0">
          ...
          <div class="tab-content" id="nav-tabContent">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="custom-select" name="Language">
                      ...
                      <option value="German">Ukraine</option>
                    </select>
                  </div>
                  <!-- ============================================= links Content Start Setting ============================================= -->
                  <div class="form-group col-md-6">
            ...
            <div class="card-footer ">
              <button class="btn btn-sm btn-accent ml-auto d-table mr-3" type="submit">Зберегти Зміни</button>
            </div>
            </form>
            <!-- ============================================= links Content Start Setting ============================================= -->
            </div>
            ...
            <div class="form-row mx-4">
             ...
             @method('PUT')
                    <div class="col-lg-12">
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">About Site Ukraine</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Title Site Ukraine</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Sub Title Site Ukraine</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">About Ukraine</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea id='edit' style="min-height: 87px;" class="form-control" name="content_about_en" value="{{ $Setting->content_about_en }}">{{ $Setting->content_about_en }}</textarea>
                     </div>
                     <div class="form-group col-md-6">
                      <label for="about_gr">Content About Ukraine</label>
                      <textarea id='edit_uk' style="min-height: 87px;" class="form-control" name="content_about_gr" value="{{ $Setting->content_about_gr }}">{{ $Setting->content_about_gr }}</textarea>
                     </div>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Content blog Ukraine</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Content Feature Ukraine</label> 
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Content Two Feature Ukraine</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Content Three Feature Ukraine</label>
