            ...
            <div class="border-bottom clearfix d-flex">
              <nav>
                ...
                <div class="nav nav-tabs mt-auto mx-4 pt-2" id="nav-tab" role="tablist" style="border-bottom: 0px solid #d1d4d8;">
                  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Головні налаштування</a>
                  <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Загальні</a>
                </div>
                <!-- ============================================= links Content Start Setting ============================================= -->
              </nav>
            </div>
                ...
                <form class="py-4">
                    ...
                    <div class="col-lg-8">
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="displayEmail">Мова Сайта | Display Language Publicly</label>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" id="firstName" placeholder="Site Title" value="{{ $Settings->SiteTitle }}" disabled>
                        </div>
                        <div class="form-group col-md-6">
                          <label for="lastName">Name</label>
                          <input type="text" class="form-control" id="lastName" value="{{ $Settings->Name }}" disabled>
                        </div>
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" value="{{ $Settings->Location }}" disabled>
                          </div>
                        </div>
                        <!-- ============================================= links Content Start Setting ============================================= -->
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" value="{{ $Settings->Googlemap }}" disabled>
                          </div>
                        </div>
                        <!-- ============================================= links Content Start Setting ============================================= -->
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" value="{{ $Settings->video }}" disabled>
                          </div>
                        </div>
                        <!-- ============================================= links Content Start Setting ============================================= -->
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" id="phoneNumber" value="{{ $Settings->PhoneNumber }}" disabled>
                          </div>
                        </div>
                        <!-- ============================================= links Content Start Setting ============================================= -->
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group input-group-seamless">
                            ...
                            <input type="email" class="form-control" id="emailAddress" placeholder="Email@Email.com" value="{{ $Settings->Email }}" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-row mx-4">
                    <div class="form-group col-md-6">
                      ...
                      <textarea style="min-height: 87px;" id="userBio" name="userBio" class="form-control" disabled>{{ $Settings->MetaDescription }}</textarea>
                    </div>
                    <script type="text/javascript">"use strict";jQuery("#userTags").tagsinput();</script>
                    <div class="form-group col-md-6">
                      <label for="userTags">Meta KeyWords</label>
                      <input data-role="tagsinput" id="userTags" name="userTags" value="{{ $Settings->MetaKeyWords }}" class="d-none" disabled>
                    </div>
                  </div>
                  <!-- ============================================= links Content Start Setting ============================================= -->
                  <hr>
                  ...
                  <div class="form-row mx-4">
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="text" class="form-control" id="socialFacebook" value="{{ $Settings->Facebook }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialTwitter" value="{{ $Settings->Twitter }}" disabled>
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="text" class="form-control" id="socialGitHub" value="{{ $Settings->GitHub }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialSlack" value="{{ $Settings->Slack }}" disabled>
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialDribbble" value="{{ $Settings->Dribbble }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->LinkedIn }}" disabled>
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->Behance }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->Digg }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->Flickr }}" disabled>
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->Vimeo }}" disabled>
                      </div>
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->youtube }}" disabled>
                      </div>
                    </div>
                    <!-- ============================================= links Content Start Setting ============================================= -->
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group input-group-seamless">
                        ...
                        <input type="email" class="form-control" id="socialGoogle" value="{{ $Settings->url_App }}" disabled>
                      </div>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="">
                    <a href="{{ url('dashboard/dashboardSettings/1/edit')}}" class="btn btn-sm btn-accent ml-auto d-table mr-3">Перейти до Редагування</a>
                  </div>
                </form>
              </div>
              ...
              <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"> <form class="py-4">
                  ...
                  <div class="form-row mx-4">
                    <div class="col-lg-12">
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Про сайт Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <!-- ============================================= links Content Start Setting ============================================= -->
                      <label for="about_gr">Назва сайта Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Для Гугл пошукача Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">О нас. Заголовок Українською</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea id='edit' style="min-height: 87px;" class="form-control">{{ $Settings->content_about_en }}</textarea>
                     </div>
                     <!-- ============================================= links Content Start Setting ============================================= -->
                     <div class="form-group col-md-6">
                      <label for="about_gr">О нас. Українською</label>
                      <textarea id='edit_uk' style="min-height: 87px;" class="form-control">{{ $Settings->content_about_gr }}</textarea>
                     </div>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Контент Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Особливість №1 Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Особливість №2 Українською</label>
                     ...
                     <div class="form-group col-md-6">
                      <label for="about_gr">Особливість №3 Українською</label>
                  ...
                  <div class="form-row mx-4">
                    <div class="col mb-3">
                      <h6 class="form-text m-0">Картинка</h6>
