    ...
    <div class="main-content-container container-fluid px-4">
      ...
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title"><i class="icon-material-outline-assignment"></i> Збір коштів 
            <a href="{{ route('dashboardCauses.create') }}" class="mb-2 btn btn-success mr-2">
              <i class="icon-material-outline-add-circle-outline"></i> Добавити</a>
          </h3>  
          </div>
        </div>
        <!-- ================================ dashboard Causes  ========================================================================= -->
          ...
          <div class="col-lg-12 mb-4">
            <div class="card card-small lo-stats h-100">
              <div class="card-header border-bottom">
                <h6 class="m-0">Останнi Збори</h6>
                <div class="block-handle"></div>
              </div>
              <div class="card-body p-0 eyes-show">
                  ...
                  <table class="table mb-0">
                    <thead class="py-2 bg-light text-semibold border-bottom">
                      <tr>
                        ...
                        <th class="text-center">Наразi</th>
                        <th class="text-center">Мета</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="lo-stats__order-details">
                          <span>{!! substr($Cause->Title_gr, 0, 190) !!}</span>
                        ...
                        <td class="lo-stats__status">
                          ...
                          @else
                           <span class="badge badge-pill badge-danger">Без категорії</span>
                          @endif
                          </div>
                        </td>
                        <!-- ================================ dashboard Causes  ========================================================================= -->
                        ...
                        <td class="lo-stats__actions">
                          ...
                          <a href="{{ URL::to('dashboard/dashboardCauses')}}/{{$Cause->slug}}/edit" class="mb-2 btn btn-sm btn-primary btn-primary-yellow">
                          <i class="icon-feather-edit-2"></i> Переглянути</a>
              ...
              <div class="card-footer border-top">
                <div class="row">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Показано від 10 до {{ COUNT($Causes) }} з {{ COUNT($Causes) }} Зборiв</a>
                    @else
                    <a>Показано від 10 до 0 з 0 Зборiв</a>
                    @endif
                    <!-- ================================ dashboard Causes  ========================================================================= -->
                  </div>
                </div>
