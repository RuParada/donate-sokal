  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Категорії 
        ...
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            <div class="card-header border-bottom">
              <h6 class="m-0">Останнi Категорії</h6>
            ...
            <i class="icon-feather-edit"></i> Редагувати</a>
           <!-- ================================ dashboard Categores store ====================================== -->
              ...
              <div class="row">
               <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Показано від 10 до {{ COUNT($Categores) }} з {{ COUNT($Categores) }} Категорій</a>
                    @else
                    <a>Показано від 10 до 0 з 0 Категорій</a>
                    @endif
                  </div>
              </div>
            </div>
