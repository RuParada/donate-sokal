...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Категорії</span>
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Категорії</h3>
      </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex px-3">
                   <a href="{{ url('dashboard/dashboardCategores') }}" class="btn btn-sm btn-outline-accent"><i class="icon-line-awesome-align-justify"></i> Категорії</a>
                  <button class="btn btn-sm btn-accent ml-auto" type="submit">
                    <i class="icon-line-awesome-align-justify"></i> Опублікувати</button>
                  </li>
                  <!-- ================================ dashboard Categores store ====================================== -->
                </ul>
              </div>
