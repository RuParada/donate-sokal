    ...
    <div class="main-content-container container-fluid px-4">
      ...
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title"><i class=" icon-feather-file-text"></i> Галерея 
            <a href="{{ route('dashboardGalleres.create') }}" class="mb-2 btn btn-success mr-2">
              <i class="icon-material-outline-add-circle-outline"></i> Добавити Картинку</a>
            </h3>  
          </div>
        </div>
        <!-- ====================== links Galleres Content Start =============================================== -->
          ...
          <div class="col-lg-12 mb-4">
            <div class="card card-small lo-stats h-100">
              <div class="card-header border-bottom">
                <h6 class="m-0">Останнi картинки</h6>
              ...
              <div class="card-footer border-top">
                <div class="row">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Показано від 10 до {{ COUNT($Galleres) }} з {{ COUNT($Galleres) }} Картинок</a>
                    @else
                    <a>Показано від 10 до 0 з 0 Galleres</a>
                    @endif
                    <!-- ====================== links Galleres Content Start =============================================== -->
                  </div>
                </div>
