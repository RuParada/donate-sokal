...
<div class="main-content-container container-fluid px-4" id="editor">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <span class="text-uppercase page-subtitle"> Галерея</span>
      <h3 class="page-title"><i class=" icon-feather-file-text"></i> Добавити Картинку</h3>
    </div>
  </div>
  <!-- ====================== links Galleres Content Start =============================================== -->
  <!-- End Page Header -->
      ...
      <div class="card card-small mb-500">
        <div id="form-container" class="card-body">
          ...
          <form action="{{ route('dashboardGalleres.store') }}" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
            @csrf
            <!-- Gallery File Upload -->
            <strong class="text-muted d-block mb-2">Завантажити Картинку</strong>
             <!-- ====================== links Galleres Content Start =============================================== -->
            <div class="input-group mb-3">
              <div class="custom-file">
                <input type="file" class="form-control-lg mb-3 custom-file-input" id="customFile2" required="" name="image">
                <label class="custom-file-label" for="customFile2">Вибрати Картинку...</label>
              </div>
            </div>
             <!-- ====================== links Galleres Content Start =============================================== -->
            <button type="submit" class="btn btn-primary">Добавити Вибрану Картинку</button>
            </form>
             <!-- ====================== links Galleres Content Start =============================================== -->
          </div>
        </div>
