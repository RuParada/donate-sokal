...
<strong>Успiх!</strong> {{ $message }}</div>
@endif 
  <!-- ============================================= links Content Start User ============================================= -->
  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class=" icon-feather-user-plus"></i> Користувачі 
          <a href="{{ route('dashboardUsers.create') }}" class="mb-2 btn btn-success mr-2">
            <i class="icon-material-outline-add-circle-outline"></i> Додати нового</a>
          </h3>  
        </div>
      </div>
      <!-- ============================================= links Content Start User ============================================= -->
        ...
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            <div class="card-header border-bottom">
              <h6 class="m-0">Останні користувачі</h6>
                ...
                <table class="table mb-0">
                  <thead class="py-2 bg-light text-semibold border-bottom">
                    <tr>
                      ...
                      <th class="text-center">Відображуване ім'я</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="lo-stats__status">
                        <div class="d-table mx-auto">
                          ...
                          @else
                          <span class="badge badge-pill badge-info">Користувач</span>
                          @endif
                        </div>
                      </td>
                      <!-- ============================================= links Content Start User ============================================= -->
                    ...
                    <a href="{{ URL::to('dashboard/dashboardUsers')}}/{{$User->name}}/edit" class="mb-2 btn btn-sm btn-primary"><i class="icon-feather-edit-2"></i> Редагувати</a>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col text-right view-report">
                    <!-- ============================================= links Content Start User ============================================= -->
                    @if(COUNT($Users) != NULL)
                    <a>Показано від 10 до {{ COUNT($Users) }} з {{ COUNT($Users) }} Користувачів</a>
                    @else
                    <a>Показано від 10 до 0 з 0 Користувача</a>
                    @endif
                    <!-- ============================================= links Content Start User ============================================= -->
                  </div>
              </div>
