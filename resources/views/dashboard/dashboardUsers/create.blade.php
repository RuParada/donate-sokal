...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      ...
      <h3 class="page-title"><i class="icon-feather-user-plus"></i> Додати користувача </h3>
    </div>
  </div>
  <!-- ============================================= links Content Start Setting ============================================= -->
  <!-- End Page Header -->
    ...
    <div class="col-lg-8">
      <div class="card card-small mb-4">
        <div class="card-header border-bottom">
          <h6 class="m-0"> Подробиці oблікового записа</h6>
        </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select id="feInputState" class="form-control" name="role_id">
                          ...
                          @else
                          <!-- ============================================= links Content Start Setting ============================================= -->
                          <span class="badge badge-pill badge-info">НЕМАЄ ролі</span>
                          @endif
                        </select> 
                      </div>
                    </div>
