...
<div class="alert alert-royal-blue alert-dismissible fade show mb-0" role="alert">
  ...
  <strong>Видылино!</strong> {{ $message }} </div>
  @endif
<!-- ====================== links Messages Content Start store =============================================== -->
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Повідомлення</span>
      </div>
      <!-- ====================== links Messages Content Start store =============================================== -->
    </div>
    <div class="row">
      <div class="col-lg-12 mb-4">
        <div class="card card-small lo-stats h-100">
          <div class="card-header border-bottom">
            <h6 class="m-0">Останнi Повідомлення</h6>
              ...
              <div class="row">
                 <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Показано від 10 до {{ COUNT($Messages) }} з {{ COUNT($Messages) }} Повідомлень</a>
                    @else
                    <a>Показано від 10 до 0 з 0 Повідомлень</a>
                    @endif
                    <!-- ====================== links Messages Content Start store =============================================== -->
                  </div>
              </div>
