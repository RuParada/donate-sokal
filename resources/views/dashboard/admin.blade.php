...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <span class="text-uppercase page-subtitle">Панель адмiна</span>
      <h3 class="page-title">Фонд Майбутнє України</h3>
    </div>
  </div>
  <!-- ================================ links Dashboard Content Start ========================================================================= -->
  <!-- End Page Header -->
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card card-small card-post card-post--1">
        <div class="card-post__image" style="background-image: url('{{ asset('dashboardassets/images/content-management/1.png') }}');border-radius: 10px">
          <a href="{{ route('dashboardUsers.index')}}" class="card-post__category badge badge-pill badge-primary">Користувачі</a>
        </div>
      </div>
      <!-- ================================ links Dashboard Content Start ========================================================================= -->
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card card-small card-post card-post--1">
        <div class="card-post__image" style="background-image: url('{{ asset('dashboardassets/images/content-management/2.png') }}');border-radius: 10px">
          <a href="{{ route('dashboardPosts.index')}}" class="card-post__category badge badge-pill badge-info">Пости</a>
        </div>
      </div>
    </div>
    <!-- ================================ links Dashboard Content Start ========================================================================= -->
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card card-small card-post card-post--1">
        <div class="card-post__image" style="background-image: url('{{ asset('dashboardassets/images/content-management/3.png') }}');border-radius: 10px">
          <a href="{{ route('dashboardRoles.index')}}" class="card-post__category badge badge-pill badge-dark">Ролі</a>
        </div>
      </div>
    </div>
    <!-- ================================ links Dashboard Content Start ========================================================================= -->
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card card-small card-post card-post--1">
        <div class="card-post__image" style="background-image: url('{{ asset('dashboardassets/images/content-management/4.png') }}');border-radius: 10px">
          <a href="{{ route('dashboardEvents.index')}}" class="card-post__category badge badge-pill badge-warning">Події</a>
        </div>
      </div>
    </div>
    <!-- ================================ links Dashboard Content Start ========================================================================= -->
        ...
        <div class="card-body p-0 d-flex">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <span class="stats-small__label text-uppercase">Користувачі</span>
              @if(count(Users()) != null)
    ...
    <div class="col-lg col-md-6 col-sm-6 mb-4">
      <div class="stats-small stats-small--1 card card-small">
        <div class="card-body p-0 d-flex">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <span class="stats-small__label text-uppercase">Пости</span>
              @if(count(Posts()) != null)
    ...
    <div class="col-lg col-md-4 col-sm-6 mb-4">
      <div class="stats-small stats-small--1 card card-small">
        <div class="card-body p-0 d-flex">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <span class="stats-small__label text-uppercase">ПРОЄКТИ ФОНДУ</span>
    ...
    <div class="col-lg col-md-4 col-sm-6 mb-4">
      <div class="stats-small stats-small--1 card card-small">
        <div class="card-body p-0 d-flex">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <span class="stats-small__label text-uppercase">Повідомлення</span>
    ...
    <div class="col-lg col-md-4 col-sm-12 mb-4">
      <div class="stats-small stats-small--1 card card-small">
        <div class="card-body p-0 d-flex">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <span class="stats-small__label text-uppercase">Події</span>
  ...
  <div class="row">
    ...
    <div class="card card-small">
      <div class="card-header border-bottom">
        <h6 class="m-0">Повідомлення з сторінки Контакти</h6>
      </div>
      ...
      <div class="card-footer border-top">
        <div class="row">
          <div class="col text-left view-report">
            <a href="{{ url('dashboard/dashboardMessages') }}" class="mb-2 btn btn-sm btn-success mr-1" style="color: #fff">Повідомлення</a>
          </div>
        </div>
      </div>
    </div>
