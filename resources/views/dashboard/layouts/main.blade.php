          ...
          <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
            <a class="navbar-brand w-100 mr-0" href="{{ url('/')}}" style="line-height: 25px;">
              <div class="d-table m-auto">
                ...
                <span class="d-none d-md-inline ml-1">Фонд Майбутнє України</span>
                @else
                @endif 
                <!-- ============================================= admin Site ============================================= -->
              </div>
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="{{ url('dashboard/dashboardUsers') }}/{{ Auth::user()->name }}/edit">
                      <i class="icon-feather-edit"></i> Редагувати профіль</a>
                      <a class="dropdown-item" href="{{ url('dashboard/dashboardSettings') }}">
                        <i class="icon-material-outline-settings"></i> Налаштування</a>
