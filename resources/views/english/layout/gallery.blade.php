...
<head>
    ...
    <meta name="keywords" content="Charity Foundation Future of Ukraine. Sokal">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <ul class="languagepicker large roundborders" id="navbar_lang">
                    <a style="cursor: pointer;"><li><span><img src="{{ asset('assets/img/english.png') }}"/></span><span style="padding-left: 7px;font-size: 16px;">English</span></li></a>
                    <a href="{!! url('German') !!}"><li><span><img src="{{ asset('assets/img/ukraine.png') }}"/></span><span style="padding-left: 7px;font-size: 16px;font-weight: 500;color: #535353;">Ukrainian</span></li></a>
                </ul>
            </div>
        </nav>
                ...
                <!-- <div class="col-md-3">
                    <div class="single-footer-widget tp_widgets">
                        ...
                        <ul class="languagepicker large roundborders">
                            <a style="cursor: pointer;"><li><img src="{{ asset('assets/img/english.png') }}"/>English</li></a>
