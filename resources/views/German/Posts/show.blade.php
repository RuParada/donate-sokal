    ...
    <section class="banner-area relative">
        ...
        <div class="container">
            <div class="row align-items-center banner-content">
                <div class="col-lg-8">
                    <!-- ===============================  Post ======================================== -->
                    <h1 class="text-white">{!! $Post->Title_gr !!}</h1>
                    <!-- ===============================  Post  ======================================== -->
                </div>
            </div>
        </div>
          ...
          <div class="single-post">
            ...
            <div class="blog_details">
              ...
              <ul class="blog-info-link mt-3 mb-4">
                ...
                @else
                <li><a><i class="icon-material-outline-assignment"></i> Без категорії</a></li>
                @endif
                @if(isset($Comments)) 
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control w-100" name="Comment" cols="30" rows="9" placeholder="Текст..."></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="col-lg-4">
          ...
          <!-- ===============================  Post  ======================================== -->
            <aside class="single_sidebar_widget popular_post_widget">
              <h3 class="widget_title">Останні публікації</h3>
